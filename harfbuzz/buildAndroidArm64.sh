...
##############################################################################################
PNG_PREFIX="${top_dir}/../png/Contrib/install-androidarm64"
...
export LDFLAGS="-lpng -lfreetype -lbz2 -L${PNG_PREFIX}/lib -L${FREETYPE_PREFIX}/lib  -no-canonical-prefixes -L${PREFIX}/lib"
