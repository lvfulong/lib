...
cmake . -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_PATH}/toolchain.cmake -DCMAKE_INSTALL_PREFIX=${PREFIX} -DZLIB_INCLUDE_DIR=${top_dir}/../zlib/Contrib/install-ios/armv7/include -DZLIB_LIBRARY=${top_dir}/../zlib/Contrib/install-ios/armv7/lib -DBUILD_SHARED_LIBS=OFF
...
cmake . -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_PATH}/toolchain.cmake -DCMAKE_INSTALL_PREFIX=${PREFIX} -DZLIB_INCLUDE_DIR=${top_dir}/../zlib/Contrib/install-ios/arm64/include -DZLIB_LIBRARY=${top_dir}/../zlib/Contrib/install-ios/arm64/lib -DBUILD_SHARED_LIBS=OFF
/Applications/Xcode.app/Contents/Developer/usr/bin/make VERBOSE=1 install
...
cmake . -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_PATH}/toolchain.cmake -DCMAKE_INSTALL_PREFIX=${PREFIX} -DZLIB_INCLUDE_DIR=${top_dir}/../zlib/Contrib/install-ios/i386/include -DZLIB_LIBRARY=${top_dir}/../zlib/Contrib/install-ios/i386/lib -DBUILD_SHARED_LIBS=OFF
/Applications/Xcode.app/Contents/Developer/usr/bin/make VERBOSE=1 install
...
cmake . -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_PATH}/toolchain.cmake -DCMAKE_INSTALL_PREFIX=${PREFIX}  -DZLIB_INCLUDE_DIR=${top_dir}/../zlib/Contrib/install-ios/x86_64/include -DZLIB_LIBRARY=${top_dir}/../zlib/Contrib/install-ios/x86_64/lib -DBUILD_SHARED_LIBS=OFF
/Applications/Xcode.app/Contents/Developer/usr/bin/make VERBOSE=1 install
